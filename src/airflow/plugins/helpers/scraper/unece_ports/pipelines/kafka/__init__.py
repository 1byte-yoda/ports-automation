...
from helpers.scraper.unece_ports.pipelines.kafka.writer import (
    ScrapyKafkaTopicWriter
)
from helpers.scraper.unece_ports.pipelines.kafka.utils import (
    get_ssl_config
)
...
class KafkaBufferPipeline(object):
    """Kafka pipeline for publishing scraper items into a kafka topic"""
    ...
    def __init__(self, crawler):
        ...
        self.kafka_topic = self.latest_topic()
